export default function Book() {
  return (
    <section className="py-20 bg-black text-white" id="book">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">

        {/* Book Image Section */}
        <div className="w-full border border-yellow-500 rounded-xl overflow-hidden bg-zinc-900">

          <div className="w-full aspect-[3/4] md:aspect-[4/5] lg:aspect-[5/6]">
            <img
              src="./assets/Book.jpg"
        ...
        <div>
          ...
          <p className="text-gray-300 leading-relaxed text-[15px]">
            ...
            across a healer who soothes them and takes them along a journey of cosmic healing.
            <br /><br />
            The pathway is intriguing yet interesting. Both characters begin journaling, watching
